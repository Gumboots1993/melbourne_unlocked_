...
export default class extends Controller {
  connect() {
    console.log("hello");
        ...
        var allMarkers = document.querySelectorAll('div.marker');
        allMarkers.forEach((marker => {
          // get the data from the attribute
          var unlocked = marker.getAttribute('data-unlocked');
